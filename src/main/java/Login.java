...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Login to site");

        txtusername.setForeground(new java.awt.Color(102, 102, 102));

        log_in.setBackground(new java.awt.Color(24, 119, 242));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(log_in, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(122, 122, 122)
    ...
    private void log_inActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_log_inActionPerformed
        ...
        final String customerpasswordhash = "Sj4RwgzAMDi5VJ+iObv0A5aHmcE0Q25+WBYqCk92RPk="; //wang123
        final String employeepasswordhash = "XohImNooBHFR0OVvjcYpJ3NgPQ1qq73WKhHvch0VQtg="; //password=password
        String encoded = "";
        try {
        ...
        if (username.equals("Customer")&&encoded.equals(customerpasswordhash)){
            encoded = "";
            Main m = new Main();
            this.hide();
            m.setVisible(true);
        }
        else if (username.equals("Employee")&&encoded.equals(employeepasswordhash)){ 
            encoded = "";
